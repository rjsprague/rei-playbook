    ...
    return (
        <>
            <main className="flex min-h-screen flex-col items-center justify-center overflow-hidden">
                ...
                <section className=" h-[90vh] flex flex-col justify-center items-center px-2 sm:px-10 overflow-hidden w-full relative">
                    <div className="backdrop-blur-md rounded-md p-4 max-w-[1280px] flex flex-col gap-4">
                        ...
                        <p className="text-white px-6">
                            Every hour a homeowner requests an offer from{" "}
                            {`${businessName}`}.
                        </p>
                    </div>
                    <Image
                ...
                <section className="flex flex-col gap-8 px-4 mt-20 items-center w-full">
                    <h2 className="text-3xl font-semibold text-center">
                        Sell to {`${businessName}`} and Skip the Hassle of Listing
                    </h2>
                    <div className="flex sm:flex-row flex-col gap-4">
                        <div className="flex flex-col gap-2 text-left max-w-[385px] sm:w-1/3">
                            ...
                            <h3 className="text-lg text-red-800 font-light uppercase">
                                Step 1
                            </h3>
                ...
                <section className="flex flex-col gap-4 px-4 mt-20 w-full items-center">
                    <h2 className="text-3xl font-semibold text-center">
                        Why Selling to {`${businessName}`} is Better
                    </h2>
                    ...
                    <div className="flex flex-row">
                        ...
                        <div className="flex flex-col justify-start gap-4 text-left">
                            ...
                            <p className="">✖️ Risk of buyer financing falling through</p>
                            <p className="">✖️ Hours of prep work and home showings</p>
                            <p className="">✖️ Managing repairs yourself</p>
                            <p className="">✖️ Uncertain closing timeline</p>
                        </div>
                    </div>
                </section>
                ...
                <section className="flex flex-col gap-8 px-4 mt-20 items-center w-full">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <div className="flex flex-col gap-2 text-left max-w-[380px] sm:w-1/4">
                            ...
                            <h3 className="text-md text-gray-500 font-semibold">Sell Fast</h3>
                        </div>
                        <div className="flex flex-col gap-2 text-left max-w-[380px] sm:w-1/4">
                            <div className="aspect-w-16 aspect-h-9">
                ...
                <footer className="flex flex-col gap-4 px-4 mt-20 w-full">
